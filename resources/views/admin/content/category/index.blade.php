                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="{{ asset($postCategory->image['indexArray'][$postCategory->image['currentImage']]) }}" alt="img" width="100" height="50">
                            </td>
                            <td>{{ $postCategory->tags }}</td>
                            <td>
                                <label for="">
                                    <input type="checkbox" name="" data-url="{{ route('admin.content.category.status', $postCategory->id) }}" onchange="changeStatus({{ $postCategory->id }})" id="{{ $postCategory->id }}" @if ($postCategory->status === 1)
                                    checked
                                    @endif>
                                </label>
                            </td>
